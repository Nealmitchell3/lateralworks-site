        ...
        <div className="max-w-8xl mx-auto px-6 lg:px-10">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {ideas.categories.map((cat) => (
              <span
                key={cat}
                className="tag cursor-pointer hover:border-navy hover:text-navy transition-colors"
              >
                {cat}
              </span>
            ))}
      ...
      <section className="bg-cream py-16 lg:py-24">
        <div className="max-w-8xl mx-auto px-6 lg:px-10">
            ...
            {ideas.articles.map((article) => (
              ...
              >
                <div className="shrink-0 sm:w-36">
                  ...
                  <p className="text-[11px] font-sans font-300 text-ink-muted mt-2">
                    {article.date}
                  </p>
                </div>
                <div className="flex-grow">
                  <h2 className="font-display text-xl lg:text-2xl font-400 text-navy mb-3 group-hover:text-navy/70 transition-colors leading-snug">
                    {article.title}
                  </h2>
          ...
          <div className="hairline pt-8 mt-8">
            <p className="text-sm font-sans font-300 text-ink-muted">
