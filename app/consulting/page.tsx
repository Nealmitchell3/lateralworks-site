        ...
        <div className="max-w-8xl mx-auto px-6 lg:px-10">
          <div className="hairline pb-6 mb-12">
            ...
            <h2 className="display-heading text-navy text-3xl lg:text-4xl">
              {consulting.model.headline}
            </h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-border">
            {consulting.model.steps.map((step) => (
              <div key={step.number} className="bg-cream p-8">
                <div className="font-display text-5xl font-300 text-navy/10 leading-none mb-6 select-none">
                  {step.number}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-border">
            {consulting.services.map((service) => (
              <div key={service.title} className="bg-cream-dark p-8">
                <h3 className="font-display text-2xl font-500 text-navy mb-4">
                  {service.title}
                </h3>
                <p className="text-[13px] font-sans font-300 text-ink-secondary leading-relaxed">
                  {service.body}
        ...
        <div className="max-w-8xl mx-auto px-6 lg:px-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-sm font-sans font-300 text-white/50">
              No obligation. We&apos;ll give you a candid view of where FTTM can help.
            </p>
          </div>
          <Link
            href="/contact"
