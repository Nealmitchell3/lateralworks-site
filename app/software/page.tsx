          ...
          <div className="max-w-8xl mx-auto px-6 lg:px-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
              <div>
                ...
                <p className="text-base font-sans font-300 text-ink-secondary leading-relaxed mb-6">
                  {product.body}
                </p>
                <div className="inline-block text-[12px] font-sans font-600 tracking-wider uppercase text-gold border border-gold px-4 py-2">
                  {product.modules}
                </div>
              </div>
              <div>
                <h3 className="text-[11px] font-sans font-600 uppercase tracking-widest text-ink-muted mb-4">
                  Key Features
                </h3>
                <ul className="space-y-3">
                  {product.features.map((f) => (
                    <li key={f} className="flex items-start gap-3">
                      ...
                      <span className="text-[13px] font-sans font-400 text-ink-secondary">
                        {f}
                      </span>
                    </li>
                  ))}
        ...
        <div className="max-w-8xl mx-auto px-6 lg:px-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div>
            <h3 className="display-heading text-white text-2xl lg:text-3xl mb-2">
              Questions about the fastWorks suite?
            </h3>
            <p className="text-sm font-sans font-300 text-white/50">
              We&apos;re happy to walk you through the software.
            </p>
          </div>
          <Link
            href="/contact"
