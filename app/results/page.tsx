    ...
    <>
      ...
      {results.caseStudies.map((study, i) => (
        <section
          key={study.id}
          id={study.id}
          className={`py-20 lg:py-28 ${i % 2 === 0 ? "bg-cream" : "bg-cream-dark"}`}
        >
          <div className="max-w-8xl mx-auto px-6 lg:px-10">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
              ...
              <div className="lg:border-r border-border pr-0 lg:pr-10">
                ...
                <div className="stat-number text-5xl lg:text-6xl text-navy mb-2">
                  {study.metric.split(" ")[0]}
                </div>
                <p className="text-sm font-sans font-300 text-ink-secondary mb-2">
                  {study.metric.split(" ").slice(1).join(" ")}
                </p>
                <p className="text-[11px] font-sans font-300 text-ink-muted uppercase tracking-wider">
                  {study.submetric}
                </p>
              </div>
              {/* Story column */}
              <div className="lg:col-span-2">
                ...
                <p className="text-base font-sans font-400 text-ink mb-4 leading-relaxed">
                  {study.body}
                </p>
        ...
        <div className="max-w-8xl mx-auto px-6 lg:px-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div>
            <h3 className="display-heading text-white text-2xl lg:text-3xl mb-2">
              Ready to add your program to this list?
            </h3>
            <p className="text-sm font-sans font-300 text-white/50">
              Let&apos;s talk about what schedule acceleration looks like for your program.
            </p>
          </div>
          <Link
            href="/contact"
